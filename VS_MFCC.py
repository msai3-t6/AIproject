...
# etc 라벨 데이터의 평균 MFCC 시각화
plt.subplot(3, 1, 1)
librosa.display.specshow(etc_mean, x_axis='time')
plt.colorbar()
plt.title('etc average')

# gaesaekki 라벨 데이터의 평균 MFCC 시각화
plt.subplot(3, 1, 2)
librosa.display.specshow(gaesaekki_mean, x_axis='time')
plt.colorbar()
plt.title('gaesaekki average')

# shibal 라벨 데이터의 평균 MFCC 시각화
plt.subplot(3, 1, 3)
librosa.display.specshow(shibal_mean, x_axis='time')
plt.colorbar()
