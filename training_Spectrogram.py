...
# 학습 불균형이 너무 심해 모델 구조 및 파라미터 일괄수정
...
# def model
model = Sequential([
    Conv2D(64, kernel_size=(3, 3), activation='relu', input_shape=(X_train.shape[1], X_train.shape[2], 1)),
...
model_checkpoint = ModelCheckpoint('saved_model/best_model_spectrogram.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
